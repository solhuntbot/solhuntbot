...
const cache = new NodeCache({ stdTTL: 600 }); // dedupe 10 min
const discoveredPairs = new Set();

const SCAN_INTERVAL = 20000; // 20 seconds

/* =====================================================
   AXIOS INSTANCE (CLEAN + CONTROLLED)
===================================================== */
...
/* =====================================================
   FETCH SOLANA PAIRS (STABLE DEXSCREENER ENDPOINT)
===================================================== */
...
`;
  ...
  try {
    ...
    console.log("Telegram send failed (handled).");
  }
}
