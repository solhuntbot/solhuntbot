...
const api = axios.create({
  timeout: 10000,
  headers: { "User-Agent": "Solana-Axiom-Scanner" }
});
...
/* ===================================================== */
/* FETCH SOLANA TOKENS (ALL DEX SOURCES) */
/* ===================================================== */
...
async function scan() {
  console.log("Scanning Solana ecosystem...");

  const pairs = await fetchSolanaTokens();
...
console.log("🚀 Solana Axiom-Style Scanner Running...");
